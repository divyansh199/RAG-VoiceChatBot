  ...
  handleMessage(ev) {
    ...
    switch (ev.type) {
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_OUTPUT:
        (_s = (_r = this._options.callbacks) == null ? void 0 : _r.onBotOutput) == null ? void 0 : _s.call(_r, ev.data);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_TRANSCRIPTION:
        (_u = (_t = this._options.callbacks) == null ? void 0 : _t.onBotTranscript) == null ? void 0 : _u.call(_t, ev.data);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_LLM_TEXT:
        (_w = (_v = this._options.callbacks) == null ? void 0 : _v.onBotLlmText) == null ? void 0 : _w.call(_v, ev.data);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_LLM_STARTED:
        (_y = (_x = this._options.callbacks) == null ? void 0 : _x.onBotLlmStarted) == null ? void 0 : _y.call(_x);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_LLM_STOPPED:
        (_A = (_z = this._options.callbacks) == null ? void 0 : _z.onBotLlmStopped) == null ? void 0 : _A.call(_z);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_TTS_TEXT:
        (_C = (_B = this._options.callbacks) == null ? void 0 : _B.onBotTtsText) == null ? void 0 : _C.call(_B, ev.data);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_TTS_STARTED:
        (_E = (_D = this._options.callbacks) == null ? void 0 : _D.onBotTtsStarted) == null ? void 0 : _E.call(_D);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_TTS_STOPPED:
        (_G = (_F = this._options.callbacks) == null ? void 0 : _F.onBotTtsStopped) == null ? void 0 : _G.call(_F);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).METRICS:
        (_I = (_H = this._options.callbacks) == null ? void 0 : _H.onMetrics) == null ? void 0 : _I.call(_H, ev.data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).SERVER_MESSAGE:
        (_K = (_J = this._options.callbacks) == null ? void 0 : _J.onServerMessage) == null ? void 0 : _K.call(_J, ev.data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).LLM_FUNCTION_CALL: {
        ...
        (_M = (_L = this._options.callbacks) == null ? void 0 : _L.onLLMFunctionCall) == null ? void 0 : _M.call(_L, data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_LLM_SEARCH_RESPONSE: {
        const data = ev.data;
        (_O = (_N = this._options.callbacks) == null ? void 0 : _N.onBotLlmSearchResponse) == null ? void 0 : _O.call(_N, data);
...
bowser/src/bowser.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CJJ4ZSPY.js.map
