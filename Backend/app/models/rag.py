...
class ChunkContent(BaseModel):
    """Clean chunk content from LLM consumption - no IDs or metadata"""
...
class RetrievalMetadata(BaseModel):
    ...
    chunks_retrieved: int = Field(..., description="Actual number of chunks retrived")
    ...
    chunks: list[ChunkMetadata] = Field(default_factory=list, description="Metadata for each retrieved")
